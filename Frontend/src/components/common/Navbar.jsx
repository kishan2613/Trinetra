    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex">
          <a
            href="/signup"
            className="px-5 py-2 rounded-lg bg-purple-600 text-white font-semibold hover:bg-purple-500 transition"
          >
            Sign Up
          </a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-black/95 backdrop-blur-lg border-t border-gray-800">
          <div className="flex flex-col space-y-4 px-6 py-4 text-gray-300">
            ...
            <a
              href="/signup"
              className="px-4 py-2 rounded-lg bg-purple-600 text-white font-semibold text-center hover:bg-purple-500 transition"
              onClick={() => setIsOpen(false)}
            >
              Sign Up
            </a>
